        ...
        <>
            ...
            >
                <div className="instructions">
                    ...
                    {/* <p>The letter turns green if the letter is in the word and in the correct spot.</p>
                    <p>The letter turns yellow if the letter is in the word but in the wrong spot.</p>
                    <p>The letter turns grey if the letter is not in the word in any spot.</p> */}
                    <hr/>
            ...
            <div className="header">
                <div className="left-icon">
                    <svg onClick={() => { setIsModalOpen(true) }} className='info' xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-info-circle" viewBox="0 0 16 16">
                ...
                <div className="right-icons">
                    ...
                    <svg className='stats' xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-bar-chart-line" viewBox="0 0 16 16">
